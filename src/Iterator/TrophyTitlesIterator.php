...
class TrophyTitlesIterator extends ApiIterator
{
    ...
    public function __construct(Client $client, LanguageType $language, array $platforms, int $limit = 128, array $collection = [])
    {
    ...
    public function current()
    {
        return new TrophyTitle(
            $this->httpClient, 
            $this->getFromOffset($this->currentOffset)->npCommunicationId,
            $this->language
        );
    }
}